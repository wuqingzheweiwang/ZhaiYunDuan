...
//#import "XHYTagView.h"
//#import "NPNewShareItem.h"
@interface DDPhotoScrollView () <UIScrollViewDelegate,UIActionSheetDelegate>
@end
...
- (instancetype)initWithFrame:(CGRect)frame urlString:(NSString *)urlString image:(UIImage *)image showInVC:(UIViewController *)VC
{
	self = [super initWithFrame:frame];
	if (self) {
		// 设置图片
		_imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, ZJAPPWidth, ZJAPPHeight)];
